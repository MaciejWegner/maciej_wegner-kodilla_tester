...
class ShopTestSuite {
    ...
    private final Order order1 = new Order(15, LocalDate.of(2021, 6, 5), "maciek");
    private final Order order2 = new Order(50, LocalDate.of(2021, 6, 10), "maciek");
    private final Order order3 = new Order(20, LocalDate.of(2021, 6, 15), "maciek");
    ...
    void shouldReturnOrderListWithGivenDateRange(){
        assertEquals(1, shop.getOrdersFromDateRange(LocalDate.of(2021,6,1),
                LocalDate.of(2021,6,6)).size());
    }
    @Test
