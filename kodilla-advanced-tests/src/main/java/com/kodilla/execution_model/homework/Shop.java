...
public class Shop {
    ...
    public static void main(String[] args) {
        ...
        Order order1 = new Order(15, LocalDate.of(2021, 6, 5), "maciek");
        Order order2 = new Order(50, LocalDate.of(2021, 6, 10), "maciek");
        Order order3 = new Order(20, LocalDate.of(2021, 6, 15), "maciek");
        Order order4 = new Order(10, LocalDate.of(2021, 6, 20), "maciek");
        ...
        List<Order> chosenOrdersList = shop.getOrdersFromDateRange(LocalDate.of(2021, 6, 4),
